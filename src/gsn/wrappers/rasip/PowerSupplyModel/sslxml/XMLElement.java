...
package gsn.wrappers.rasip.PowerSupplyModel.sslxml;
...
public class XMLElement
{
    ...
    /**
	 * Child elements of the element. <dl><dt><b>Invariants:</b></dt><dd> <ul><li>The field can be empty. <li>The field is never <code>null</code>. <li>The elements are instances of <code>XMLElement</code> or a subclass of <code>XMLElement</code>. </ul></dd></dl>
    ...
    /**
	 * The name of the element. <dl><dt><b>Invariants:</b></dt><dd> <ul><li>The field is <code>null</code> iff the element is not initialized by either parse or setName. <li>If the field is not <code>null</code>, it's not empty. <li>If the field is not <code>null</code>, it contains a valid XML identifier. </ul></dd></dl>
    ...
    /**
	 * The #PCDATA content of the object. <dl><dt><b>Invariants:</b></dt><dd> <ul><li>The field is <code>null</code> iff the element is not a #PCDATA element. <li>The field can be any string, including the empty string. </ul></dd></dl>
    ...
    /**
	 * The line number where the element starts. <dl><dt><b>Invariants:</b></dt><dd> <ul><li><code>lineNr &gt= 0</code> </ul></dd></dl>
	 * @uml.property  name="lineNr"
	 */
    private int lineNr;
     ...
     *         XMLElement(Hashtable, boolean)
     */
    public XMLElement(final Hashtable entities)
    {
     ...
     */
    protected XMLElement(final Hashtable entities,
                         final boolean   skipLeadingWhitespace,
                         ...
                         final boolean   ignoreCase)
    {
        ...
        this.lineNr = 0;
        final Enumeration enumer = this.entities.keys();
    ...
    /**
	 * Returns the line nr in the source data on which the element is found. This method returns <code>0</code> there is no associated source data. <dl><dt><b>Postconditions:</b></dt><dd> <ul><li><code>result >= 0</code> </ul></dd></dl>
	 * @uml.property  name="lineNr"
	 */
                               ...
                               final int    defaultValue)
    {
        ...
        final String value = (String) this.attributes.get(name);
        if (value == null) {
            return defaultValue;
        } else {
            try {
     ...
     */
    public double getProperty(final String name,
                              final double defaultValue)
    {
     ...
     */
    public boolean getProperty(final String  key,
                               final String  trueValue,
                               final String  falseValue,
                               final boolean defaultValue)
    {
     ...
     *             getIntAttribute} instead.
     */
    public int getSpecialIntProperty(final String    name,
                                     final Hashtable valueSet,
                                     final String    defaultKey)
    {
     ...
     *             getDoubleAttribute} instead.
     */
    public double getSpecialDoubleProperty(final String    name,
                                           final Hashtable valueSet,
                                           final String    defaultKey)
    {
     ...
     *     If an error occured while parsing the string.
     */
    public void parseCharArray(final char[] input,
                               final int    offset,
                               final int    end)
        throws XMLParseException
    {
    ...
    /**
	 * Changes the name of the element.
	 * @param name  The new name.  </dl><dl><dt><b>Preconditions:</b></dt><dd>  <ul><li><code>name != null</code>  <li><code>name</code> is a valid XML identifier  </ul></dd></dl>
        ...
        throws IOException
    {
        ...
        if (! this.attributes.isEmpty()) {
            final Enumeration enumer = this.attributes.keys();
            while (enumer.hasMoreElements()) {
                writer.write(' ');
                final String key = (String) enumer.nextElement();
                final String value = (String) this.attributes.get(key);
                writer.write(key);
        ...
        if ((this.contents != null) && (this.contents.length() > 0)) {
            ...
            writer.write('>');
            final Enumeration enumer = this.enumerateChildren();
            while (enumer.hasMoreElements()) {
                final XMLElement child = (XMLElement) enumer.nextElement();
                child.write(writer);
            }
            writer.write('<'); writer.write('/');
            writer.write(this.name);
     ...
     * </ul></dd></dl>
     */
    protected void writeEncoded(final Writer writer,
                                final String str)
        throws IOException
    {
        ...
        throws IOException
    {
        ...
        if (key.charAt(0) == '#') {
            ...
            final char[] value = (char[]) this.entities.get(key);
            if (value == null) {
                throw this.unknownEntity(key);
            }
            buf.append(value);
    ...
    protected XMLParseException invalidValue(final String name,
                                             final String value)
    {
        final String msg = "Attribute \"" + name + "\" does not contain a valid "
                   + "value (\"" + value + "\")";
        return new XMLParseException(this.getName(), this.parserLineNr, msg);
    }
