...
public interface WebConstants {
   ...
   public static final int	  MISSING_SOCKET_NUMBER                  = 502;
   
   public static final int    MISSING_ACTION_DEFINITION              = 503;
   
   public static final int    MISSING_BOARD_ID                       = 504;
   
   public static final int    SOCKET_ACTION_ERROR                    = 505;
   
   public static final int    BOARD_NOT_EXIST                        = 506;
